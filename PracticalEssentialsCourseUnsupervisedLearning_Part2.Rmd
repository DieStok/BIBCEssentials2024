...
#Answer: 
 ...
 I trust you know the drill. Run UMAP and plot the results. Be sure to read a little bit of https://umap-learn.readthedocs.io/en/latest/ to understand the basic parameters. The function call is umap()
...
There's a dataset of gene expression values of lung cancer patients and healthy controls in this folder
called 'subsampled_49_healthy_49_lungcancer_TCGA.csv'. Can you use dimensionality
reduction and clustering to get a useful visualisation? Attempt it in your team and find out!

```{r}
fileName = "subsampled_49_healthy_49_lungcancer_TCGA.csv"
#Your code here
```
...
##########
#
# Everything below here is entirely optional, but left in for people who
# Like to see ghostly faces built from PCA 
#
##########
